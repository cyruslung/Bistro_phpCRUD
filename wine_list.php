    ...
    <table id="data-table" class="table table-striped table-bordered table-hover">
        ...
        <?php while($r=$stmt->fetch()) { ?> <!--拿到第一筆資料 如果為true 開始執行-->
            <tr>
                ...
                <td><!-- 產品圖片 -->
                    <a href="<?= 'lib/images/wine/uploads/' . $r['my_file'] ?>" data-lightbox="<?= 'lib/images/wine/uploads/' . $r['my_file'] ?>" data-title="My caption"><img class="thumbImage " src="<?= 'lib/images/wine/uploads/' . $r['my_file'] ?>"></a>
                </td>
                <td><!-- 上下架判斷 -->
                    <?php if ($r['block']) { ?>
